...
// total_coeffs: ZigZag扫描后序列中非0值的个数
...
// trailing_ones: 拖尾系数，代表ZigZag扫描后序列中+1，和-1的总个数，如果超过3，则为3，在ZigZag扫描序列中从右到左选取三个
...
// totalzeros: 最后一个非零系数之前 0 的个数
// runbefore: 每个系数前面 0 的数目
// zerosLeft: 非零系数左边的所有 0 的个数
